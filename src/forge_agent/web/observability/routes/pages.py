...
from forge_agent.web.observability.data.code import CodeSource
from forge_agent.web.observability.data.manifest import load_manifest
from forge_agent.web.observability.data.traces import TraceDataSource
...
async def metrics_page(request: Request) -> HTMLResponse:
    ...
    templates = _get_templates()
    from forge_agent.web.observability.data.metrics import MetricsDataSource
...
async def reports_page(request: Request) -> HTMLResponse:
    ...
    templates = _get_templates()
    from forge_agent.web.observability.data.reports import ReportDataSource
