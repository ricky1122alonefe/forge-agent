...
Moved from builtin/chief_agent.py (S2.5): Chief is a pipeline orchestration
component, not a builtin utility. GuardRailEngine / ChiefPrompts extraction
deferred to S6 (core slim-down).
