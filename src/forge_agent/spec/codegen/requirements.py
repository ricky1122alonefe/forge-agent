...
class RequirementsParser:
    ...
    DEFAULT_CAPABILITIES: ClassVar[list[str]] = ["log"]  # always
    COMMON_CAPABILITIES: ClassVar[dict[str, list[str]]] = {
    ...
    AGENT_TYPE_KEYWORDS: ClassVar[dict[str, list[str]]] = {
    ...
    async def _parse_with_llm(self, requirement: str) -> AgentRequirements:
        from forge_agent.spec.codegen.prompts import REQUIREMENTS_PARSER_SYSTEM
    ...
    def _parse_heuristic(self, requirement: str) -> AgentRequirements:
        ...
        return AgentRequirements(
            ...
            inputs=[
                FieldSpec(name="payload", type="dict", description="Run payload", required=True)
            ],
            outputs=[
