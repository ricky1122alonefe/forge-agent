...
from forge_agent.spec.codegen.generator import CodeGenerator, GenerationContext, GenerationResult
from forge_agent.spec.codegen.registry_getter import get_registry_lazy
from forge_agent.spec.codegen.requirements import RequirementsParser
from forge_agent.spec.codegen.sandbox import Sandbox, SmokeTestResult
from forge_agent.spec.codegen.store import FileCodeStore, SavedCode
from forge_agent.spec.codegen.validator import ContractValidator, ValidationResult
    ...
    async def generate_and_deploy(
        ...
        *,
        ...
        if deploy_mode == DeployMode.AUTO_DEPLOY and saved:
            try:
                from forge_agent.spec.codegen.injector import AgentInjector
