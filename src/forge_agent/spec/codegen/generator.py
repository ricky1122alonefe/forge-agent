...
from forge_agent.spec.codegen.prompt_provider import (
    PromptProvider,
    get_prompt_provider,
)
...
from forge_agent.spec.codegen.requirements import AgentRequirements
...
class CodeGenerator:
    ...
    async def generate(self, ctx: GenerationContext) -> GenerationResult:
        ...
        for attempt in range(1, self.max_attempts + 1):
            ...
            from forge_agent.spec.codegen.templates import get_template
