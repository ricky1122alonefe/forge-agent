...
| ID | 任务 | 状态 | 完成时间 | 验证命令 | 通过 |
|---|---|---|---|---|---|
| T1.1 | OpenAI 真实 provider 跑通 | ⬜ | — | `OPENAI_API_KEY=xxx pytest tests/e2e/test_openai_real.py` | — |
| T1.2 | 生成代码 Validator 强化 | ⬜ | — | `pytest tests/unit/test_validator.py` | — |
| T1.3 | 沙箱真隔离 | ⬜ | — | `pytest tests/unit/test_sandbox.py` | — |
| T1.4 | 端到端测试套件 | ⬜ | — | `pytest tests/e2e/test_generation_e2e.py` | — |
| T1.5 | 失败回滚 + 二次重试 | ⬜ | — | `pytest tests/unit/test_retry.py` | — |
...
| ID | 任务 | 状态 | 完成时间 | 验证命令 | 通过 |
|---|---|---|---|---|---|
| T2.1.1 | AgentType 枚举 | ⬜ | — | `pytest tests/unit/test_agent_type.py` | — |
