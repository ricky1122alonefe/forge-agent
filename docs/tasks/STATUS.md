...
| ID | 任务 | 状态 | 完成时间 | 验证命令 | 通过 |
|---|---|---|---|---|---|
| T3.1 | mkdocs 文档站 | ✅ | 2026-06-27 15:00 | `mkdocs build --strict` | PASS |
| T3.2 | forge-agent new 模板完整化 | ✅ | 2026-06-27 14:20 | `pytest tests/unit/test_templates_new.py` | 37/37 |
| T3.3 | 错误信息友好化 | ✅ | 2026-06-27 14:10 | `pytest tests/unit/test_error_messages.py` | 84/84 |
| T3.4 | JSON Schema / Pydantic 校验 | ✅ | 2026-06-27 14:25 | `pytest tests/unit/test_pydantic_validation.py` | 30/30 |
| T3.5 | OpenTelemetry 集成 | ✅ | 2026-06-27 14:35 | `pytest tests/integration/test_otel.py` | 46/46 |
| T3.6 | forge-agent doctor 命令 | ✅ | 2026-06-27 14:15 | `pytest tests/unit/test_cli_doctor.py` | 22/22 |
| T3.7 | 真实 demo 视频 | ⬜ | — | (人工验证) | — |
| T3.8 | PyPI 发布准备 | ✅ | 2026-06-27 15:10 | `python -m build` | PASS |
