...
- 19 个新测试（contextvars / 双 renderer / 并发隔离 / agent 集成）
...
- 15 CLI commands (generate, list, history, use, rollback, diff, manifest, save, restore, archive, delete, llm, new, logs)
- Sandbox 模块
- 40 tests passing
...
- [ ] 执行 T0.6（端到端冒烟）—— 依赖 T0.1 + T0.2 + T0.3
